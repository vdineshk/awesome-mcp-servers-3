...
- [Dominion Observatory](https://github.com/vdineshk/dominion-observatory) - Behavioral trust scoring for 22,500+ MCP servers. Provides trust scores (0.0-1.0), SLA grades, and anomaly detection via a free API.
