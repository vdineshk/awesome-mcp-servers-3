...
- [Dominion Observatory](https://github.com/vdineshk/dominion-observatory) - Behavioral trust scoring and MCP gateway proxy for 14,820+ MCP servers. Trust-verified proxy routes agent calls through Observatory for automatic trust checks and MiCA Article 12 compliance attestation receipts.
